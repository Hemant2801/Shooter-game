...
grenade_snd = pygame.mixer.Sound('audio/audio_grenade.wav')
grenade_snd.set_volume(0.5)
    ...
    def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
        ...
        for animation in animation_list:
            ...
            for i in range(no_of_frames):
                player = pygame.image.load(f'sprites/{self.char_type}/{animation}/{i}.png').convert_alpha()
                char = pygame.transform.scale(player,(int(player.get_width() * scale), int(player.get_height() * scale)))
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        enemy = Character('enemy', x * TILE_SIZE, y * TILE_SIZE, 1.65, 3, 50, 0)
...
while run:
    ...
    if start_game == False:
        ...
        #SHOW AMMO
        draw_text(f'AMMO :', font, WHITE , 10, 40)
